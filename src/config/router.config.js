...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '会员管理', icon: 'user', permission: ['user'] },
        children: [
          {
            path: '/vipManage/list',
            name: 'vipManage',
            component: () => import(/* webpackChunkName: "fail" */ '@/views/business/vipManage/list'),
            meta: { title: '会员列表', permission: ['user'] }
          }
        ]
      },
      {
        ...
        component: RouteView,
        redirect: '/chart/list',
        meta: { title: '客服', icon: 'user', permission: ['user'] },
        children: [
          {
            path: '/chart/list',
            name: 'chart',
            component: () => import(/* webpackChunkName: "fail" */ '@/views/business/chart/index'),
            meta: { title: '客服', permission: ['user'] }
          }
        ]
      },
      {
